  ...
  return (
    <>
        ...
        <section className="container-portfilio">
            <div className="title">
                <h1 className="text-first-color fw-bold">Company <span className="text-second-color">Information</span></h1>
            </div>
                            ...
                            <div className="card mb-4">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="row gx-3 mb-3">
                                        ...
                                        <div className="col-md-6">
                                            <h6>The amount of waste produced per week :</h6>
                                            <h2 className='main-color'>100 KG</h2> 
                                        </div>
                                    </div>
                                    ...
                                    <div className="mb-3">
                                        <div className="select text-center">
                                            <h6 className="mb-3">Type of waste produced :</h6>
